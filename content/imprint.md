---
title: "Imprint"
description: "Imprint and privacy policy for the JudaicaLink project website."
keywords: ["imprint", "legal", "responsibility", "privacy", "cookies"]
...
Prof. Dr. Kai Eckert  
Mannheim Technical University (Technische Hochschule Mannheim)  
Paul-Wittsack-Straße 10  
68163 Mannheim  
Germany

**Phone:** +49 (0) 621 292-6225  
**Contact:** <a href="https://www.kaiec.de">www.kaiec.de</a>

Mannheim Technical University is a corporation under public law
(Körperschaft des öffentlichen Rechts), legally represented by the Rektorin.
...
[legal notice of Mannheim Technical University](https://www.th-mannheim.de/en/legal-notice).
...
does not process data you enter.

**Server logs.** When you access the site, your browser transmits data that is recorded in
the server log, including your IP address, the requested page, and the time of the request.
This is needed to deliver the site and to keep it secure.
...
Senckenberg in Frankfurt am Main, under its own responsibility and its own privacy policy.
See [JudaicaLink in production](/production/).
